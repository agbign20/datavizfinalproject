...
I started wrapping up the app by cleaning up the graphs and titles for the shiny app and the graphs. I also played around the graph to make sure there are no errors and to make sure the app is finalized.
